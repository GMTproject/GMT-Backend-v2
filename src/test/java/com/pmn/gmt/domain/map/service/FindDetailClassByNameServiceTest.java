...
@Transactional
@Rollback
public class FindDetailClassByNameServiceTest {
    ...
    public void findClassByNameTest(){
        ...
        assertThat(findDetailClassByNameService.execute(new ClassNameDto("테스트 교실2")).getLocation()).isEqualTo(Structure.DORMITORY);
