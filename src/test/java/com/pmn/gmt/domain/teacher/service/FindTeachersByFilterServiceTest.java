...
import com.pmn.gmt.domain.teacher.service.impl.FindTeachersByFilterServiceImpl;
...
public class FindTeachersByFilterServiceTest {
    ...
    public void setup() {
        ...
        findTeachersByFilterService = new FindTeachersByFilterServiceImpl(teacherRepository,teacherConverter);
    }
